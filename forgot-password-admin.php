...
if (isset($_POST['submit'])) {
    ...
    $query = mysqli_query($con, "select IDadmin from tbladmin where email='$email' and nohp='$nohp' ");
    $ret = mysqli_fetch_array($query);
    if ($ret > 0) {
        $_SESSION['nohp'] = $nohp;
        $_SESSION['email'] = $email;
        header('location:reset-password-admin.php');
    } else {
...
<head>
    ...
    <title>Hello World - Admin Lupa Password</title>
