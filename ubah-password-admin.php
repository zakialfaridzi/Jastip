...
if (strlen($_SESSION['jastip'] == 0)) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $pass_skrg = $_POST['passwordskrg'];
        $pass_baru = $_POST['passwordbaru'];
        $query = mysqli_query($con, "select IDadmin from tbladmin where IDadmin='$adminid' and password='$pass_skrg'");
        $row = mysqli_fetch_array($query);
        if ($row > 0) {
            $ret = mysqli_query($con, "update tbladmin set password='$pass_baru' where IDadmin='$adminid'");
...
<head>
    ...
    <title>HelloWorld - Admin Ganti Password</title>
...
<body>
   ...
   <?php include_once 'includes/header.php';?>
        ...
        echo $msg;
                                   ...
                                   <?php
$adminid = $_SESSION['jastip'];
    $ret = mysqli_query($con, "select * from tbladmin where IDadmin='$adminid'");
    $cnt = 1;
