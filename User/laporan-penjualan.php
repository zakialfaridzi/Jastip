...
$idlog = $_SESSION['jastip'];
    $ret = mysqli_query($con, "select * from tbltransaksi tt join tbluser tu on tt.fk_idpembeli=tu.IDuser where fk_idpenjasa='$idlog'");
    $cnt = 1;
    while ($row = mysqli_fetch_array($ret)) {
        ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="view-laporan-penjualan.php?viewid=<?php echo $row['IDtransaksi']; ?>"><font color="Blue">Rincian</font></a>
                                    </td>
                                </tr>
    <?php $cnt++;}?>
                            </table>
