...
if (isset($_POST['submit'])) {
    $contactno = $_SESSION['nohp'];
    $email = $_SESSION['email'];
    $password = $_POST['passwordbaru'];

    $query = mysqli_query($con, "update tbluser set Password='$password'  where  Email='$email' && NoHP='$contactno' ");
    if ($query) {
...
<head>
    ...
    <title>HelloWorld - Reset Password</title>
