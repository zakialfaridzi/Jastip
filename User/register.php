...
if (isset($_POST['login'])) {
    ...
    $query = mysqli_query($con, "INSERT INTO `tbluser`(`nama`, `username`, `email`, `nohp`, `alamat`, `gender`, `noktp`, `password`, `foto`, `norek`) VALUES (
        '$nama',
        '$uname',
        '$email',
        '$nohp',
...
<body class="bg-dark">
    ...
    echo $msg;
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="norek" placeholder="456380XXXXXXX" required="true">   
                        </div>
                        <div class="form-group">
