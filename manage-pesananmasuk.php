...
<head>
    ...
    <title>HelloWorld - Admin Manage Barang Masuk</title>
     ...
     <?php include_once 'includes/header.php';?>
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="manage-pesananmasuk.php">Manage Pesanan</a></li>
                                    <li class="active">Manage Pesanan Masuk</li>
                                </ol>
                            </div>
                        </div>
                    </div>
        ...
        <div class="content">
            <div class="animated fadeIn">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Manage Pesanan Masuk</strong>
                        </div>
                        <div class="card-body">
                             <table class="table">
                <thead>
               ...
               <?php
$ret = mysqli_query($con, "SELECT * from vprint where status='in process'");
    $cnt = 0;
    ...
    while ($row = mysqli_fetch_array($ret)) {
        ...
        ?>
                ...
                <tr>
                  ...
                  <td>
                    <a href="view-pesananmasuk.php?viewid=<?php echo $row['IDtransaksi']; ?>">View</a>
                  </td>
                  <td>
