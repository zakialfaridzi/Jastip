...
if (strlen($_SESSION['jastip'] == 0)) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $query = mysqli_query($con, "update tbladmin set NamaAdmin ='$nama', NoHP='$nohp' where IDadmin='$userid'");
        if ($query) {
...
<head>
    ...
    <title>HelloWorld - Profile admin</title>
...
<body>
   ...
   <?php include_once 'includes/header.php';?>
        ...
        echo $msg;
                                   ...
                                   <?php
$userid = $_SESSION['jastip'];
    $ret = mysqli_query($con, "select * from tbladmin where IDadmin='$userid'");
    $cnt = 1;
    while ($row = mysqli_fetch_array($ret)) {
        ...
        ?>
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input class=" form-control" id="nama" name="nama" type="text" value="<?php echo $row['NamaAdmin']; ?>"></div>
                                    </div>
                                    <div class="row form-group">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"> <input class="form-control " id="nohp" name="nohp" type="text" value="<?php echo $row['NoHP']; ?>" required="true"></div>
                                    </div>
                                    <div class="row form-group">
